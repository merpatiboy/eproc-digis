...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Salutation Management</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="modal fade " id="AddModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="AddModalLabel">Add Salutation</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label >Salutation Name</label>
                        <input type="text" class="form-control" id="addSalutation">
                </div>
                <div class="modal-footer">
...
<div class="modal fade " id="EditModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="AddModalLabel">Edit Salutation</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label >Salutation Name</label>
                        <input type="text" class="form-control" id="editSalutationName">
                </div>
                <div class="modal-footer">
    ...
    $(document).ready(function() {
        ...
        $('.add_btn').click(function(e) {
         ...
         $("#dataTable").on("click", ".edit_btn", function(e) {
             e.preventDefault();
             var name_salutation  = $(this).parent().prev().html();
             $('#editSalutationName').val(name_salutation);
